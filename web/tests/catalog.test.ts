...
const primary: Deployment = { chainId: 31337, name: "Local", rpcUrl: "http://127.0.0.1:8545", explorerUrl: "", factory: null, deploymentBlock: null, marketId: "primary", version: 4, feeRecipient: "0x4444444444444444444444444444444444444444", baseFee: "10000", feeBps: 10, underlying: token, quote: { ...token, address: "0x2222222222222222222222222222222222222222", symbol: "USD", decimals: 6 } };
