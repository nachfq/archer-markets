...
const exports = [ ['optionFactoryAbi', 'OptionFactory'], ['optionAbi', 'Option'], ['erc20Abi', 'MockUSD'], ['optionMarketV4Abi', 'OptionMarketV4'], ['optionV4Abi', 'OptionV4'] ];
...
await writeFile(atRoot('web/lib/generated/abis.ts'), '// Generated SDK ABI re-export. Do not edit.\nexport { optionAbi, optionFactoryAbi, optionMarketV4Abi, optionV4Abi, erc20Abi, faucetAbi } from \"@stock-options-lab/sdk/abis\";\n');
