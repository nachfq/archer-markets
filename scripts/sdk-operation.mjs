...
export const marketFromManifest = record => ({ id: record.marketId ?? 'primary', chainId: record.chainId, factory: record.factory, deploymentBlock: BigInt(record.deploymentBlock), version: 4, feeRecipient: record.feeRecipient, baseFee: BigInt(record.baseFee), feeBps: record.feeBps, underlying: record.underlying, quote: record.quote, sandbox: record.underlying.isMock });
